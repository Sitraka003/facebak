    ...
    return (
        <section className="h-screen">
            <div className="h-full container mx-auto px-6 flex flex-col items-center justify-center">
                <div className="g-6 flex flex-wrap items-center justify-center lg:justify-between h-fit w-full">
                    <div className="shrink-1 mb-12 grow-0 basis-auto md:mb-0  md:shrink-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        <h1 className="mb-5 text-2xl font-semibold text-white">
                            Sign up now and embark on a limitless journey of
                            ...
                            <div className="flex justify-between mt-10">
                                ...
                                <div className="flex flex-row items-center justify-center lg:justify-start">
                                    ...
                                    <button
                                        ...
                                        className="mx-1 h-9 w-9 text-white hover:bg-gray-400 "
                                    >
                                        <AiOutlineGoogle />
                                    </button>
