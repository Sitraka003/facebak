        ...
        <>
            <div className="Landing">
                <nav className="navbar navbar-expand-custom navbar-mainbg">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ml-auto">
                            ...
                            <div className="nav-item" id="searchbar">
                                <div> <input type="text" class="form-control" placeholder="Recherche"></input></div>
                            </div>
                    ...
                    <div>
                        <button type="button" className="sign-up-btn" id="UserIcone">
                            ...
                            <div class="d-none d-md-block col-md-4 col-xl-3 left-wrapper">
                                <div class="card rounded">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-3">
                                            <label class="tx-11 font-weight-bold  text-uppercase">Joined:</label>
                                            <p class="text-muted">November 15, 2015</p>
                                        </div>
                                        <div class="mt-3">
                                            <label class="tx-11 font-weight-bold  text-uppercase">Lives:</label>
